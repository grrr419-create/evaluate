...
브라우저는 무작위 토큰을 localStorage에 보관합니다. 서버는 평가 회차별 비밀값으로 변환한 토큰만으로 중복 참여를 확인합니다. 제출 전에 다시 접속하면 같은 참여 기록을 사용하고 이전 세션을 만료시킵니다. 제출 후 다시 참여하면 “평가는 기기 당 1회 참여할 수 있습니다.”라고 안내합니다. 관리자 초기화는 참여 기록을 삭제하고 회차 비밀값을 바꾸므로 같은 브라우저에서 다시 참여할 수 있습니다. 작성 중인 답변은 브라우저를 닫으면 저장되지 않습니다.
