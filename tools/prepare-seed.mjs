...
const source={mode:'nickname',revision:input.revision,survey_version:input.survey_version,notice:input.notice,notice_version:input.notice_version,questions:input.questions};
